...
<div align="center">
  <img src="./assets/architecture.svg" alt="Enterprise Agentic AI & Hybrid RAG Architecture" width="100%" />
</div>

<br/>

<details>
  <summary><b>📊 Click to expand interactive Mermaid architecture pipeline</b></summary>
  <br/>

```mermaid
flowchart TB
    subgraph S1 ["1. Ingestion & Preprocessing"]
        A["📄 Multi-Source Ingestion<br/><i>PDFs • Databases • Streams</i>"] --> B["⚡ Chunking & OCR Extraction<br/><i>YOLOv8 • EasyOCR</i>"]
    end

    subgraph S2 ["2. Dual-Tier Hybrid Retrieval"]
        B --> C1["🧠 Dense Vector Search<br/><i>FAISS • PgVector • Pinecone</i>"]
        B --> C2["🔍 Sparse Lexical Search<br/><i>BM25 Keyword Index</i>"]
        C1 & C2 --> D["🎯 Reciprocal Rank Fusion & Cross-Encoder Rerank"]
    end

    subgraph S3 ["3. Agentic Orchestration & Tools"]
        D --> E1["🤖 Primary Coordinator Agent<br/><i>Goal Decomposition & Planning</i>"]
        E1 <--> E2["🛠️ Dynamic Tool Calling<br/><i>APIs • Code Exec • Web Crawl</i>"]
    end

    subgraph S4 ["4. Safety Guardrails & Delivery"]
        E1 --> F{"🛡️ Grounding & Guardrails<br/><i>UQML Hallucination Check</i>"}
        F -- "⚠️ Hallucination Detected (Reflection)" --> E1
        F -- "✅ Validated & Grounded" --> G["🚀 High-Throughput Production API<br/><i>FastAPI Async • Low-Latency Streaming</i>"]
    end
