<div align="center">
  ...
  <!-- Hero Header Vector Banner (Fluid Responsive Width) -->
  ...
  <!-- Dynamic Typing Subtitle (Responsive Fluid Scaling) -->
  <a href="https://github.com/lasithadilshan">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=20&duration=2500&pause=800&color=38BDF8&center=true&vCenter=true&width=700&height=45&lines=AI+Engineer+%26+Generative+AI+Specialist;Architecting+Autonomous+Agentic+Workflows;Building+Enterprise+RAG+%26+Document+Intelligence;1st+Place+Winner+%E2%80%93+Virtusa+Agentic+AI+Hackathon;Transforming+LLMs+into+Scalable+Production+Software" alt="Typing Dynamic Subtitle" width="100%" />
  </a>

  <br/>

  <!-- Quick Info & Action Badges (Fluid Responsive Wrapping) -->
  <p align="center">
...
<div align="center">
  <img src="./assets/persona.svg" alt="Lasitha Dilshan - Engineering Specification & Profile Telemetry" width="100%" />
</div>
...
<div align="center">
  ...
  <!-- Tier 1: AI, Backend & Cloud Infrastructure (Responsive Strip) -->
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=py,fastapi,flask,docker,aws,gcp,postgres,mysql,linux" alt="AI, Backend and Cloud Stack" width="100%" />
  </a>

  <br/><br/>

  <!-- Tier 2: Modern Frontend & Developer Tooling (Responsive Strip) -->
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=ts,js,angular,react,nextjs,tailwind,git,github,postman,vscode" alt="Frontend and Tooling Stack" width="100%" />
  </a>
...
![Hybrid Search](https://img.shields.io/badge/Dense_%2B_BM25_Hybrid-8B5CF6?style=for-the-badge&logo=search&logoColor=white)
...
```mermaid
flowchart TD
    A["📥 Unstructured Data Ingestion"] --> B["✂️ Semantic Chunking & Vector Indexing"]
    B --> C["🔍 Hybrid Retrieval (Dense Vector + BM25)"]
    C --> D["🎯 Cross-Encoder Reranking & Context Compression"]
